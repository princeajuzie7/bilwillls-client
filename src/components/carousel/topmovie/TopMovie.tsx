        ...
        <div className="slider">
          <div className="flex items-start relative">
            <div className="slider--col relative ">
              <div className="hidden lg:block vertical-slider-prev swiper-button absolute z-10 left-0 right-0 my-0 mx-auto top-[-40px]  ">
                <i>
                  <svg
              ...
              <div className="hidden lg:block vertical-slider-next swiper-button absolute z-10 left-0 right-0 my-0 mx-auto bottom-[-40px] ">
                <i>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    ...
                    <SwiperSlide key={movie.id}>
                      <div className="relative top-movieblock">
                        <div className="slider--image img-box">
                          <img
                            src={movie.imageUrl}
                            className=" mix-blend-overlay max-w-full h-full w-full"
                            alt="X-Men"
                            loading="lazy"
                          />
                        </div>
